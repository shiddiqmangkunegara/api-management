...
Route::middleware(['auth:sanctum', 'check.api.access'])->group(function () {
    ...
    //PERKULIAHAN
        ...
        Route::get('konversi-kampus-merdeka', [SatuDataController::class, 'konversi_kampus_merdeka'])->name('api.perkuliahan.konversi-kampus-merdeka');
        Route::get('krs-mahasiswa', [SatuDataController::class, 'krs_mahasiswa'])->name('api.perkuliahan.krs-mahasiswa');
        ...
        Route::get('mata-kuliah', [SatuDataController::class, 'mata_kuliah'])->name('api.referensi.mata-kuliah');
        Route::get('matkul-kurikulum', [SatuDataController::class, 'matkul_kurikulum'])->name('api.referensi.matkul-kurikulum');
        Route::get('media-publikasi', [SatuDataController::class, 'media_publikasi'])->name('api.referensi.media-publikasi');

        Route::get('negara', [SatuDataController::class, 'negara'])->name('api.referensi.negara');
        Route::get('nilai-perkuliahan', [SatuDataController::class, 'nilai_perkuliahan'])->name('api.referensi.nilai-perkuliahan');
        Route::get('nilai-transfer-pendidikan', [SatuDataController::class, 'nilai_transfer_pendidikan'])->name('api.referensi.nilai-transfer-pendidikan');
        Route::get('pangkat-golongan', [SatuDataController::class, 'pangkat_golongan'])->name('api.referensi.pangkat-golongan');
        Route::get('pekerjaan', [SatuDataController::class, 'pekerjaan'])->name('api.referensi.pekerjaan');
        Route::get('pembiayaan', [SatuDataController::class, 'pembiayaan'])->name('api.referensi.pembiayaan');
        Route::get('penghasilan', [SatuDataController::class, 'penghasilan'])->name('api.referensi.penghasilan');
        Route::get('penugasan-dosen', [SatuDataController::class, 'penugasan_dosen'])->name('api.referensi.penugasan-dosen');
        Route::get('penulis-paten', [SatuDataController::class, 'penulis_paten'])->name('api.referensi.penulis-paten');
        Route::get('penulis-publikasi', [SatuDataController::class, 'penulis_publikasi'])->name('api.referensi.penulis-publikasi');
        Route::get('perguruan-tinggi', [SatuDataController::class, 'perguruan_tinggi'])->name('api.referensi.perguruan-tinggi');
        Route::get('periode-lampau', [SatuDataController::class, 'periode_lampau'])->name('api.referensi.periode-lampau');
        Route::get('products', [SatuDataController::class, 'products'])->name('api.referensi.products');
        Route::get('profil-pt', [SatuDataController::class, 'profil_pt'])->name('api.referensi.profil-pt');
        Route::get('program-studi', [SatuDataController::class, 'program_studi'])->name('api.referensi.program-studi');
        Route::get('reg-daerah', [SatuDataController::class, 'reg_daerah'])->name('api.referensi.reg-daerah');
        Route::get('reg-propinsi', [SatuDataController::class, 'reg_propinsi'])->name('api.referensi.reg-propinsi');
        Route::get('reg-sma', [SatuDataController::class, 'reg_sma'])->name('api.referensi.reg-sma');
        Route::get('rencana-evaluasi', [SatuDataController::class, 'rencana_evaluasi'])->name('api.referensi.rencana-evaluasi');
        Route::get('rencana-pembelajaran', [SatuDataController::class, 'rencana_pembelajaran'])->name('api.referensi.rencana-pembelajaran');
        Route::get('riwayat-fungsional-dosen', [SatuDataController::class, 'riwayat_fungsional_dosen'])->name('api.referensi.riwayat-fungsional-dosen');
        Route::get('riwayat-nilai-mahasiswa', [SatuDataController::class, 'riwayat_nilai_mahasiswa'])->name('api.referensi.riwayat-nilai-mahasiswa');
        Route::get('riwayat-pangkat-dosen', [SatuDataController::class, 'riwayat_pangkat_dosen'])->name('api.referensi.riwayat-pangkat-dosen');
        Route::get('riwayat-pendidikan-dosen', [SatuDataController::class, 'riwayat_pendidikan_dosen'])->name('api.referensi.riwayat-pendidikan-dosen');
        Route::get('riwayat-pendidikan-mahasiswa', [SatuDataController::class, 'riwayat_pendidikan_mahasiswa'])->name('api.referensi.riwayat-pendidikan-mahasiswa');
        Route::get('riwayat-penelitian-dosen', [SatuDataController::class, 'riwayat_penelitian_dosen'])->name('api.referensi.riwayat-penelitian-dosen');
        Route::get('riwayat-sertifikasi-dosen', [SatuDataController::class, 'riwayat_sertifikasi_dosen'])->name('api.referensi.riwayat-sertifikasi-dosen');
        Route::get('semester', [SatuDataController::class, 'semester'])->name('api.referensi.semester');
        Route::get('simak-dosens', [SatuDataController::class, 'simak_dosens'])->name('api.referensi.simak-dosens');
        Route::get('simak-kehadiran-dosen', [SatuDataController::class, 'simak_kehadiran_dosen'])->name('api.referensi.simak-kehadiran-dosen');
        Route::get('simak-kehadiran-mahasiswa', [SatuDataController::class, 'simak_kehadiran_mahasiswa'])->name('api.referensi.simak-kehadiran-mahasiswa');
        Route::get('simak-kelas', [SatuDataController::class, 'simak_kelas'])->name('api.referensi.simak-kelas');
        Route::get('simak-mahasiswas', [SatuDataController::class, 'simak_mahasiswas'])->name('api.referensi.simak-mahasiswas');
        Route::get('simak-matakuliahs', [SatuDataController::class, 'simak_matakuliahs'])->name('api.referensi.simak-matakuliahs');
        Route::get('simak-transkrips', [SatuDataController::class, 'simak_transkrips'])->name('api.referensi.simak-transkrips');
        Route::get('simak-tugas-akhir', [SatuDataController::class, 'simak_tugas_akhir'])->name('api.referensi.simak-tugas-akhir');
        Route::get('simak-yudisium', [SatuDataController::class, 'simak_yudisium'])->name('api.referensi.simak-yudisium');
        Route::get('sister-agama', [SatuDataController::class, 'sister_agama'])->name('api.referensi.sister-agama');
        Route::get('sister-bidang-studi', [SatuDataController::class, 'sister_bidang_studi'])->name('api.referensi.sister-bidang-studi');
        Route::get('sister-bidang-usaha', [SatuDataController::class, 'sister_bidang_usaha'])->name('api.referensi.sister-bidang-usaha');

        Route::get('sister-detail-ajuan-jabatan-fungsional', [SatuDataController::class, 'sister_detail_ajuan_jabatan_fungsional'])->name('api.referensi.sister-detail-ajuan-jabatan-fungsional');
        Route::get('sister-detail-ajuan-kepangkatan', [SatuDataController::class, 'sister_detail_ajuan_kepangkatan'])->name('api.referensi.sister-detail-ajuan-kepangkatan');
        Route::get('sister-detail-ajuan-nilai-tes', [SatuDataController::class, 'sister_detail_ajuan_nilai_tes'])->name('api.referensi.sister-detail-ajuan-nilai-tes');
        Route::get('sister-detail-ajuan-pendidikan-formal', [SatuDataController::class, 'sister_detail_ajuan_pendidikan_formal'])->name('api.referensi.sister-detail-ajuan-pendidikan-formal');
        Route::get('sister-detail-ajuan-sertifikasi-dosen', [SatuDataController::class, 'sister_detail_ajuan_sertifikasi_dosen'])->name('api.referensi.sister-detail-ajuan-sertifikasi-dosen');
        Route::get('sister-detail-anggota-profesi', [SatuDataController::class, 'sister_detail_anggota_profesi'])->name('api.referensi.sister-detail-anggota-profesi');
        Route::get('sister-detail-bahan-ajar', [SatuDataController::class, 'sister_detail_bahan_ajar'])->name('api.referensi.sister-detail-bahan-ajar');
        Route::get('sister-detail-beasiswa', [SatuDataController::class, 'sister_detail_beasiswa'])->name('api.referensi.sister-detail-beasiswa');
        Route::get('sister-detail-bimbingan-mahasiswa', [SatuDataController::class, 'sister_detail_bimbingan_mahasiswa'])->name('api.referensi.sister-detail-bimbingan-mahasiswa');
        Route::get('sister-detail-detasering', [SatuDataController::class, 'sister_detail_detasering'])->name('api.referensi.sister-detail-detasering');
        Route::get('sister-detail-diklat', [SatuDataController::class, 'sister_detail_diklat'])->name('api.referensi.sister-detail-diklat');
        Route::get('sister-detail-inpassing', [SatuDataController::class, 'sister_detail_inpassing'])->name('api.referensi.sister-detail-inpassing');
        Route::get('sister-detail-jabatan-fungsional', [SatuDataController::class, 'sister_detail_jabatan_fungsional'])->name('api.referensi.sister-detail-jabatan-fungsional');
        Route::get('sister-detail-jabatan-struktural', [SatuDataController::class, 'sister_detail_jabatan_struktural'])->name('api.referensi.sister-detail-jabatan-struktural');
        Route::get('sister-detail-kekayaan-intelektual', [SatuDataController::class, 'sister_detail_kekayaan_intelektual'])->name('api.referensi.sister-detail-kekayaan-intelektual');
        Route::get('sister-detail-kepangkatan', [SatuDataController::class, 'sister_detail_kepangkatan'])->name('api.referensi.sister-detail-kepangkatan');
        Route::get('sister-detail-kesejahteraan', [SatuDataController::class, 'sister_detail_kesejahteraan'])->name('api.referensi.sister-detail-kesejahteraan');
        Route::get('sister-detail-nilai-tes', [SatuDataController::class, 'sister_detail_nilai_tes'])->name('api.referensi.sister-detail-nilai-tes');
        Route::get('sister-detail-orasi-ilmiah', [SatuDataController::class, 'sister_detail_orasi_ilmiah'])->name('api.referensi.sister-detail-orasi-ilmiah');
        Route::get('sister-detail-pembicara', [SatuDataController::class, 'sister_detail_pembicara'])->name('api.referensi.sister-detail-pembicara');
        Route::get('sister-detail-pendidikan-formal', [SatuDataController::class, 'sister_detail_pendidikan_formal'])->name('api.referensi.sister-detail-pendidikan-formal');
        Route::get('sister-detail-penelitian', [SatuDataController::class, 'sister_detail_penelitian'])->name('api.referensi.sister-detail-penelitian');
        Route::get('sister-detail-pengabdian', [SatuDataController::class, 'sister_detail_pengabdian'])->name('api.referensi.sister-detail-pengabdian');
        Route::get('sister-detail-pengajaran', [SatuDataController::class, 'sister_detail_pengajaran'])->name('api.referensi.sister-detail-pengajaran');
        Route::get('sister-detail-pengelola-jurnal', [SatuDataController::class, 'sister_detail_pengelola_jurnal'])->name('api.referensi.sister-detail-pengelola-jurnal');
        Route::get('sister-detail-penghargaan', [SatuDataController::class, 'sister_detail_penghargaan'])->name('api.referensi.sister-detail-penghargaan');
        Route::get('sister-detail-pengujian-mahasiswa', [SatuDataController::class, 'sister_detail_pengujian_mahasiswa'])->name('api.referensi.sister-detail-pengujian-mahasiswa');
        Route::get('sister-detail-penugasan', [SatuDataController::class, 'sister_detail_penugasan'])->name('api.referensi.sister-detail-penugasan');
        Route::get('sister-detail-penunjang-lain', [SatuDataController::class, 'sister_detail_penunjang_lain'])->name('api.referensi.sister-detail-penunjang-lain');
        Route::get('sister-detail-publikasi', [SatuDataController::class, 'sister_detail_publikasi'])->name('api.referensi.sister-detail-publikasi');
        Route::get('sister-detail-riwayat-pekerjaan', [SatuDataController::class, 'sister_detail_riwayat_pekerjaan'])->name('api.referensi.sister-detail-riwayat-pekerjaan');
        Route::get('sister-detail-sertifikasi-dosen', [SatuDataController::class, 'sister_detail_sertifikasi_dosen'])->name('api.referensi.sister-detail-sertifikasi-dosen');
        Route::get('sister-detail-sertifikasi-profesi', [SatuDataController::class, 'sister_detail_sertifikasi_profesi'])->name('api.referensi.sister-detail-sertifikasi-profesi');
        Route::get('sister-detail-tugas-tambahan', [SatuDataController::class, 'sister_detail_tugas_tambahan'])->name('api.referensi.sister-detail-tugas-tambahan');
        Route::get('sister-detail-tunjangan', [SatuDataController::class, 'sister_detail_tunjangan'])->name('api.referensi.sister-detail-tunjangan');
        Route::get('sister-detail-visiting-scientist', [SatuDataController::class, 'sister_detail_visiting_scientist'])->name('api.referensi.sister-detail-visiting-scientist');
        Route::get('sister-gelar-akademik', [SatuDataController::class, 'sister_gelar_akademik'])->name('api.referensi.sister-gelar-akademik');
        Route::get('sister-golongan-pangkat', [SatuDataController::class, 'sister_golongan_pangkat'])->name('api.referensi.sister-golongan-pangkat');
        Route::get('sister-ikatan-kerja', [SatuDataController::class, 'sister_ikatan_kerja'])->name('api.referensi.sister-ikatan-kerja');
        Route::get('sister-jabatan-fungsional', [SatuDataController::class, 'sister_jabatan_fungsional'])->name('api.referensi.sister-jabatan-fungsional');
        Route::get('sister-jabatan-negara', [SatuDataController::class, 'sister_jabatan_negara'])->name('api.referensi.sister-jabatan-negara');
        Route::get('sister-jabatan-tugas-tambahan', [SatuDataController::class, 'sister_jabatan_tugas_tambahan'])->name('api.referensi.sister-jabatan-tugas-tambahan');
        Route::get('sister-jenis-beasiswa', [SatuDataController::class, 'sister_jenis_beasiswa'])->name('api.referensi.sister-jenis-beasiswa');
        Route::get('sister-jenis-diklat', [SatuDataController::class, 'sister_jenis_diklat'])->name('api.referensi.sister-jenis-diklat');
        Route::get('sister-jenis-dokumen', [SatuDataController::class, 'sister_jenis_dokumen'])->name('api.referensi.sister-jenis-dokumen');
        Route::get('sister-jenis-keluar', [SatuDataController::class, 'sister_jenis_keluar'])->name('api.referensi.sister-jenis-keluar');
        Route::get('sister-jenis-kepanitiaan', [SatuDataController::class, 'sister_jenis_kepanitiaan'])->name('api.referensi.sister-jenis-kepanitiaan');
        Route::get('sister-jenis-kesejahteraan', [SatuDataController::class, 'sister_jenis_kesejahteraan'])->name('api.referensi.sister-jenis-kesejahteraan');
        Route::get('sister-jenis-pekerjaan', [SatuDataController::class, 'sister_jenis_pekerjaan'])->name('api.referensi.sister-jenis-pekerjaan');
        Route::get('sister-jenis-penghargaan', [SatuDataController::class, 'sister_jenis_penghargaan'])->name('api.referensi.sister-jenis-penghargaan');
        Route::get('sister-jenis-publikasi', [SatuDataController::class, 'sister_jenis_publikasi'])->name('api.referensi.sister-jenis-publikasi');
        Route::get('sister-jenis-tes', [SatuDataController::class, 'sister_jenis_tes'])->name('api.referensi.sister-jenis-tes');
        Route::get('sister-jenis-tunjangan', [SatuDataController::class, 'sister_jenis_tunjangan'])->name('api.referensi.sister-jenis-tunjangan');
        Route::get('sister-kategori-capaian-luaran', [SatuDataController::class, 'sister_kategori_capaian_luaran'])->name('api.referensi.sister-kategori-capaian-luaran');
        Route::get('sister-kategori-kegiatan', [SatuDataController::class, 'sister_kategori_kegiatan'])->name('api.referensi.sister-kategori-kegiatan');

        Route::get('sister-media-publikasi', [SatuDataController::class, 'sister_media_publikasi'])->name('api.referensi.sister-media-publikasi');
        Route::get('sister-negara', [SatuDataController::class, 'sister_negara'])->name('api.referensi.sister-negara');
        Route::get('sister-perguruan-tinggi', [SatuDataController::class, 'sister_perguruan_tinggi'])->name('api.referensi.sister-perguruan-tinggi');
        Route::get('sister-sdm', [SatuDataController::class, 'sister_sdm'])->name('api.referensi.sister-sdm');
        Route::get('sister-semester', [SatuDataController::class, 'sister_semester'])->name('api.referensi.sister-semester');
        Route::get('sister-status-kepegawaian', [SatuDataController::class, 'sister_status_kepegawaian'])->name('api.referensi.sister-status-kepegawaian');
        Route::get('sister-sumber-gaji', [SatuDataController::class, 'sister_sumber_gaji'])->name('api.referensi.sister-sumber-gaji');
        Route::get('sister-tingkat-penghargaan', [SatuDataController::class, 'sister_tingkat_penghargaan'])->name('api.referensi.sister-tingkat-penghargaan');
        Route::get('sister-wilayah', [SatuDataController::class, 'sister_wilayah'])->name('api.referensi.sister-wilayah');
        Route::get('status-keaktifan-pegawai', [SatuDataController::class, 'status_keaktifan_pegawai'])->name('api.referensi.status-keaktifan-pegawai');
        Route::get('status-kepegawaian', [SatuDataController::class, 'status_kepegawaian'])->name('api.referensi.status-kepegawaian');
        Route::get('status-mahasiswa', [SatuDataController::class, 'status_mahasiswa'])->name('api.referensi.status-mahasiswa');
        Route::get('sumber-gaji', [SatuDataController::class, 'sumber_gaji'])->name('api.referensi.sumber-gaji');
        Route::get('tahun-ajaran', [SatuDataController::class, 'tahun_ajaran'])->name('api.referensi.tahun-ajaran');
        Route::get('tingkat-penghargaan', [SatuDataController::class, 'tingkat_penghargaan'])->name('api.referensi.tingkat-penghargaan');
        Route::get('tingkat-prestasi', [SatuDataController::class, 'tingkat_prestasi'])->name('api.referensi.tingkat-prestasi');
        Route::get('transkrip-mahasiswa', [SatuDataController::class, 'transkrip_mahasiswa'])->name('api.referensi.transkrip-mahasiswa');
        Route::get('unit-kerja', [SatuDataController::class, 'unit_kerja'])->name('api.referensi.unit-kerja');
        Route::get('wilayah', [SatuDataController::class, 'wilayah'])->name('api.referensi.wilayah');
    });
});