...
Route::middleware(['auth:sanctum', 'check.api.access'])->group(function () {
    ...
    // DOSEN
        ...
        Route::get('detail_penelitian', [SatuDataController::class, 'get_detail_penelitian'])->name('api.dosen.get-detail-penelitian');
        // GET detail_penugasan_dosen
        Route::get('detail_penugasan_dosen', [SatuDataController::class, 'get_detail_penugasan_dosen'])->name('api.dosen.get-detail-penugasan-dosen');
        // GET dokumen
        Route::get('dokumen', [SatuDataController::class, 'get_detail_ajuan_sertifikasi_dosen'])->name('api.dosen.get-dokumen');
        // GET dokumen_paten
        ...
        Route::get('dokumen-publikasi', [SatuDataController::class, 'get_detail_publikasi'])->name('api.dosen.get-dokumen-publikasi');
